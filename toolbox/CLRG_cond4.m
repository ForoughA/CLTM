function [adjmatTree, edge_distance,adjmatCL,adjmatCLmi] = CLRG_cond4(stats, useDistances, numSamples,covariates)
...
edge_distance = contractWeakEdges4(edge_distance,m);
