function [adjmatTree, edge_distance] = CLRG3(stats, useDistances, numSamples,covariates)
...
if useDistances
    ...
    [cov_prob_Xk,prob_bij,nodeSpecProb] = computeBnCondStats3(samples,covariates);
    distance = computeCondDistance3(prob_bij,cov_prob_Xk,nodeSpecProb);    
end
