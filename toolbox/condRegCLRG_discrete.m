function [adjmatTree, edge_distance, nodePot, edgePot, ll, bic] = ...
    condRegCLRG_discrete(samples, options,covariates)
...
%     tic;
%     distance = computeCondDistance(prob_bij,cov_prob_Xk,mar_prob);
%     t2 = toc;
