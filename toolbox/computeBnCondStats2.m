function [cov_prob_Xk,cond_prob_bij] = computeBnCondStats2(samples,covariates)

%covariates should be a 1/2 binary matrix and are fixed in time
...
covariateStates = zeros(Nc,1);%matrix containing the covariate states of each node sample
for n = 1:Nc
