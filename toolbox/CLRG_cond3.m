function [adjmatTree, edge_distance,adjmatCL,adjmatCLmi] = CLRG_cond3(stats, useDistances, numSamples,covariates)
...
edge_distance = contractWeakEdges3(edge_distance,m);
