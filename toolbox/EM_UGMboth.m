function [Params,dParams,llEM,EcllEM] = EM_UGMboth(adjmat,samples,covariates,depCovariates,options)
...
%         nodePot(nObs+1:nTot,1) = ones(nHidden,1);
        ...
        for e=1:nEdges
            ...
            edgePot(2,2,:) = exp(reshape(depCovariates(par,child,:,t),[1,ndepCov])*dParams);
        end
