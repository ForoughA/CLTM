function [adjmatTree, edge_distance,adjmatCL,adjmatCLmi] = CLRG3ary_cond(stats, useDistances, numSamples,covariates,thrsh)
...
if useDistances
    ...
    tic;
    [cov_prob_Xk,prob_bij,mar_prob] = compute3aryCondStats(samples,covariates);
    t1 = toc;
    fprintf('time spent for computing binary statistics: %f \n',t1);
    disp('compuitng conditinal distances... \n') 
    tic;
    distance = compute3aryCondDistance(prob_bij,cov_prob_Xk,mar_prob);
    t2 = toc;
