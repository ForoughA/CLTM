function [adjmatTree, edge_distance,adjmatCL,adjmatCLmi] = CLRG_cond5(stats, useDistances, numSamples,covariates)
...
edge_distance = contractWeakEdges5(edge_distance,m);
