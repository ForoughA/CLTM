...
<!-- saved from url=(0072)http://www.di.ens.fr/~mschmidt/Software/UGM/updates/UGM_CRF_NLL_Hidden.m -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">function [NLL,g] = UGM_CRF_NLL_Hidden(w,Xnode,Xedge,Y,nodeMap,edgeMap,edgeStruct,inferFunc,varargin)
