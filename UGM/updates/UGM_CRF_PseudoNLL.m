...
<!-- saved from url=(0071)http://www.di.ens.fr/~mschmidt/Software/UGM/updates/UGM_CRF_PseudoNLL.m -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1"></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">function [NLL,g] = UGM_loss(w,Xnode,Xedge,Y,nodeMap,edgeMap,edgeStruct)
