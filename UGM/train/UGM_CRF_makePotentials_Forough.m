function [nodePot,edgePot] = UGM_CRF_makePotentials_Forough(w,Xnode,Xedge,nodeMap,edgeMap,edgeStruct,i)
...
if edgeStruct.useMex
    ...
    for n = 1:nNodes
        for s = 1:nStates(n)
            ...
            nodePot(n,s) = exp(nodePot(n,s));%Omit???
        end
    end
        ...
        for e = 1:nEdges
            ...
            for s1 = 1:nStates(n1)
                for s2 = 1:nStates(n2)
                    ...
                    edgePot(s1,s2,e) = exp(edgePot(s1,s2,e));%Omit???
                end
            end
        end
    end
